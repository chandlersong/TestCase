...
@ContextConfiguration(locations = "classpath:inAction_chapter5_inheritance_union.xml")
public class InheritanceUnionTest extends AbstractJUnit4SpringContextTests {
