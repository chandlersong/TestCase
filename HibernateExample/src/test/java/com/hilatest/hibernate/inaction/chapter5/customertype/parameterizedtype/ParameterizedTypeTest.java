...
@ContextConfiguration(locations = "classpath:inAction_chapter5_customerType_parameterizedtype.xml")
public class ParameterizedTypeTest extends AbstractJUnit4SpringContextTests {
