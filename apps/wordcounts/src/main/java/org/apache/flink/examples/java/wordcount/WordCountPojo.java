...
/**
 * This example shows an implementation of org.apache.flink.examples.java.wordcount.WordCount without using the
...
public class WordCountPojo {
	...
	public static void main(String[] args) throws Exception {
		...
		if (params.has("output")) {
			...
			// execute program
			env.execute("org.apache.flink.examples.java.wordcount.WordCount-Pojo Example");
		} else {
