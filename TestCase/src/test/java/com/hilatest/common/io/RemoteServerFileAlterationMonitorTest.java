 ...
 *
 */
public class RemoteServerFileAlterationMonitorTest {

	private static final String MonitorFolder = "\\\\10.112.39.144\\nas\\Temp";
	
	private static Logger logger = Logger.getLogger(RemoteServerFileAlterationMonitorTest.class);
