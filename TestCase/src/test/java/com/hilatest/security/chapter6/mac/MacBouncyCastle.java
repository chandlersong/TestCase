...
public class MacBouncyCastle extends SuperTestCase{
	...
	public void initial(){
		...
		algorithms.add("HmacMD2");
		algorithms.add("HmacMD4");
		algorithms.add("HmacSHA224");
	}
	
	public void testHmacMD5(String algorithm) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException{
	...
	@Test
	public void testMAC() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException{
